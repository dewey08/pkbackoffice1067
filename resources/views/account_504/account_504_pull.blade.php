                ...
                <div class="card cardacc">
                    <div class="card-body">
                        ...
                        <div class="row mb-3"> 
                            <div class="col"></div>
                            <div class="col-md-2 text-end">
                                <button type="button" class="ladda-button me-2 btn-pill btn btn-sm btn-primary cardacc Savestamp" data-url="{{url('account_504_stam')}}">
                                    <i class="fa-solid fa-file-waveform me-2"></i>
                                    ตั้งลูกหนี้
                                </button>
                                <button type="button" class="ladda-button me-2 btn-pill btn btn-sm btn-danger cardacc Destroystamp" data-url="{{url('account_504_destroy')}}">
