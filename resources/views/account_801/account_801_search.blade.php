                            ...
                            <tbody>
                                ...
                                @endforeach  
                                        ...
                                        <tr style="background-color: #f3fca1">
                                            ...
                                            <td class="text-end" style="background-color: #e09be9;color:rgb(3, 3, 3)">{{ number_format($total6,2)}}</td> 
                                            <td class="text-end" style="background-color: #f5a382;color:rgb(3, 3, 3)">{{ number_format($total7,2)}}</td> 
                                            <td class="text-end" style="background-color: #047c5e;color:rgb(3, 3, 3)">{{ number_format($total8,2)}}</td>  
